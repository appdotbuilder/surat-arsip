...
class UpdateOutgoingLetterRequest extends FormRequest
{
    ...
    {
        return [
            'letter_number' => 'required|string|max:255|unique:outgoing_letters,letter_number,' . $this->route('outgoing_letter')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'sent_date.required' => 'Tanggal dikirim wajib diisi.',
